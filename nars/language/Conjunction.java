...
public class Conjunction extends CompoundTerm {
     ...
     */
    protected Conjunction(String n, ArrayList<Term> cs, ArrayList<Variable> open, short i) {
        super(n, cs, open, i);
    }
    ...
    public Object clone() {
        return new Conjunction(name, (ArrayList<Term>) cloneList(components), (ArrayList<Variable>) cloneList(openVariables), complexity);
    }
